...
object KEncryptDecryptUtil {
    ...
    fun BASE64_encrypt2Bytes(data: ByteArray?): ByteArray? {
        return if (data == null) {
            null
        } else KBase64Util.encode(data).toByteArray()
    }

    fun BASE64_encrypt2Bytes(data: String?): ByteArray? {
        return if (data == null) {
            null
        } else KBase64Util.encode(data.toByteArray()).toByteArray()
    }

    fun BASE64_encrypt2String(data: ByteArray?): String? {
        return if (data == null) {
            null
        } else KBase64Util.encode(data)
    }
    ...
    fun BASE64_decrypt2Bytes(data: String?): ByteArray? {
        return if (data == null) {
            null
        } else KBase64Util.decode(data)
    }

    fun BASE64_decrypt2String(data: String?): String? {
        return if (data == null) {
            null
        } else String(KBase64Util.decode(data)!!)
    }
